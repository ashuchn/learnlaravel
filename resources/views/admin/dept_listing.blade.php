  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        >
        <a href="assign-dept" class="list-group-item list-group-item-action py-2 ripple"
...
<main style="margin-top: 58px;">
  <div class="container pt-4">
      ...
      <div class="row">
          <div class="col">
                <div class="alert display-6">Department Listing</div>
          </div>
            ...
            <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <?php 
                              $name = DB::table('tbl_employee')->where('id', $rows->dept_head)->get('name');
                              echo $name[0]->name;     
