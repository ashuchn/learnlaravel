  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="all-employees" class="list-group-item list-group-item-action py-2 ripple active">
          <i class="fas fa-chart-area fa-fw me-3"></i><span>Employees</span>
        </a>
        <a href="all-department" class="list-group-item list-group-item-action py-2 ripple"
...
<main style="margin-top: 58px;">
  <div class="container pt-4">
      <div class="row">
          <div class="col">
                <div class="alert display-6">Employees Listing</div>
          </div>
