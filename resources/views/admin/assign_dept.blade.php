          ...
          <div class="col">
            ...
            <div class="card">
                            ...
                            <!-- <div class="card-title"><b>Add Employee</b></div> -->
                                <form action="assign_Dept_post" method="post">
                                @csrf
                                        <p>
                                            <label for="name">Department Name:</label>
                                            <!-- <input type="text" class="form-control" name="dept_name" required> -->
                                            <select name="dept_id" class="form-control" id="dept_id" required onChange="return fetchEmployee()">
                                                <option value="" disabled selected>Select Department</option>
                                                @forelse($dept as $rows)
                                                <option value="{{ $rows->id }}">{{ $rows->dept_name }}</option>
                                                @empty
                                                Nothing Found
                                                @endforelse
                                            </select>
...
<script>
         function fetchEmployee() {
          ...
          var dpt_id = document.getElementById('dept_id').value;
          // alert(dpt_head);
